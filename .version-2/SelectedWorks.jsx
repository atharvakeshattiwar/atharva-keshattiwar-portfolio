...
const projects = [
  { title: 'Pizza Hut Malaysia', image: img1, tags: ['FoodTech', 'Ordering Experience', 'E-commerce'] },
  { title: 'Novus Design System', image: img2, tags: ['Design System', 'Scalable UX', 'Infrastructure'] },
  { title: 'SwapEasy', image: img3, tags: ['B2B SaaS', 'Recommerce', 'Enterprise UX'] },
  { title: 'Dr. Pashu', image: img4, tags: ['HealthTech', 'SaaS', 'Consultation Platform'] },
...
function WorkCard({ title, image, tags }) {
  ...
  return (
    <a ref={ref} href="#" className="sw-card sw-animate">
