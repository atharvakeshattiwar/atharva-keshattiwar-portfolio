...
const mainLinks = [
  ...
  { label: 'Project Single', href: '/project/creativox' },
]

const moreLinks = [
  { label: 'Services', href: '/services' },
  { label: 'Articles', href: '/articles' },
  { label: 'Article single', href: '/blog/creative-cloud-tools-for-designers-and-developers' },
...
function FooterLink({ label }) {
  return (
    <a href="#" className="fooer-link-block">
          ...
          <div className="footer-content-1">
            <div ref={topRef} className="footer-top animate-fade-in">
              ...
              <div className="footer-right">
                <a href="mailto:miller@gmail.com" className="footer-headline-link">
                  <div className="section-headline-text">miller@gmail.com</div>
                  <div className="footer-header-link-icon">
                    <img src={footerArrow} alt="" className="footer-header-link-img" />
                  </div>
                </a>
                <div className="footer-links-wrapper">
                  <FooterLinkColumn title="Main Pages" links={mainLinks} />
                  <FooterLinkColumn title="More Pages" links={moreLinks} />
            ...
            <div ref={bottomRef} className="footer-bottom animate-fade-in">
              <div className="text-sm text-color-black-700">
                Design by <a href="#" className="footer-span-link">Quix Studio</a>
              </div>
              <div className="text-sm text-color-black-700">
                Copyright © Atharva K. All Rights Reserved
              </div>
              <div className="text-sm text-color-black-700">
                Powered by <a href="#" className="footer-span-link">Webflow</a>
              </div>
            </div>
          </div>
          <div ref={bigTextRef} className="footer-content-2 animate-fade-in">
            <div className="hero-headline-text footer">Atharva K.</div>
          </div>
        </div>
      </div>
    </section>
